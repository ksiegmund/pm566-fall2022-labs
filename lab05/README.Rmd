...
Now it turns out I've done this a very inefficient way (see an efficient approach in the answer to question Q3.)  BUT, it gives us practice with merging so I'll leave this for all to see.  Then, you will REALLY appreciate the shortcuts we could have taken when you get to Q3.
...
Going back to read the directions once more, I realize I was supposed to use quantile() function instead of median().  We're asked to use it again in Q3 so read ahead to find how to use quantile() to find the median.
...
The orange dots show the weather station most central to all locations in the state, and the aqua dots show those with weather most repesentative of the weather in the state. Most states have 2 dots.  In Florida, Kentucky, and West Virginia there is only 1 dot, and the color appears to be a mixture of the 2 colors in the legend, suggesting it's the same weather station that is centrally located and reporting the average weather for the state.
